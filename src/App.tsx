    ...
    <Router>
      <Layout>
        <Routes>
          ...
          <Route path="/about" element={<div className="container" style={{padding: '100px 0'}}><h1>About Bahri</h1><p>This is a placeholder for the About page.</p></div>} />
          <Route path="/units" element={<div className="container" style={{padding: '100px 0'}}><h1>Bahri Units</h1><p>This is a placeholder for the Business Units page.</p></div>} />
